...
import com.rawat.dagger2.mvvm.dagger.util.Constants.API_FAILED_CODE
import com.rawat.dagger2.mvvm.dagger.util.Constants.API_INTERNET_CODE
import com.rawat.dagger2.mvvm.dagger.util.Constants.API_INTERNET_MESSAGE
import com.rawat.dagger2.mvvm.dagger.util.NetWorkResult
import com.rawat.dagger2.mvvm.dagger.util.Utils
        ...
        instance?.let {
            ...
            for (property in properties) {
                if (property is KMutableProperty<*>) {
                    when (property.name) {
                        "ErrorCode" -> property.setter.call(
                            instance,
                            errorCode
                        )

                        "Message" -> property.setter.call(
                            instance,
                            message
                        )
                    }
